      ...
      Please select a agency.
                          ...
                          {/*   <div className="col-md-6">
                            ...
                            <div className="col-md-12">
                                ...
                                <input type="text" required className={accessCode.trim().length == 0?"form-control is-invalid":"form-control"}  id="validationServerUsername" name="accessCode" value={accessCode} onChange={ItemValue=>this.ChangeValueInput(ItemValue)}/>
