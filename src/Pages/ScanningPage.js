...
getActivitiesData () {
    ...
    const API='http://150.200.3.16:29173/api/DC/TimeAttendance/AreaActivityList'
          ...
          submitEmployeeRecord = (itemValue)=>{
            ...
            const {area,areaSeq}= this.state
                 ...
                 if(responseStatus.status === 200){
                    ...
                    console.log('resultValue.Table[0].Column1: ', resultValue.Table[0].Column1.slice(0,22) )
            ...
            <div className="IndexBody"
                ...
                <div className='d-grid gap-4 mx-auto'>
                    ...
                    <div className="container" style={{width:this.state.ActivityArea.length=== 1?'20%':'100%'}}>
                      <div className={this.state.ActivityArea.length ===1?"row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-1":this.state.ActivityArea.length ===2?"row row-cols-2 row-cols-sm-2 row-cols-md-2 row-cols-lg-2":"row row-cols-2 row-cols-sm-2 row-cols-md-4 row-cols-lg-4"}>
...
<FcSettings  style={
                            {position: 'absolute',
                            left: 10,
                            bottom: 10, }} size="50" onClick={()=>{this.setState({setTerminalModal: true})}}/>
